...
require (
	...
	code.cloudfoundry.org/existingvolumebroker v0.165.0
...
require (
	code.cloudfoundry.org/cfhttp/v2 v2.34.0 // indirect
	code.cloudfoundry.org/credhub-cli v0.0.0-20250219235359-bc9098574636 // indirect
	code.cloudfoundry.org/dockerdriver v0.38.0 // indirect
	code.cloudfoundry.org/tlsconfig v0.18.0 // indirect
	code.cloudfoundry.org/volumedriver v0.119.0 // indirect
