...
require (
	code.cloudfoundry.org/cfhttp/v2 v2.70.0 // indirect
	code.cloudfoundry.org/credhub-cli v0.0.0-20260302140100-b28cba4f6966 // indirect
	code.cloudfoundry.org/dockerdriver v0.78.0 // indirect
	code.cloudfoundry.org/tlsconfig v0.46.0 // indirect
	code.cloudfoundry.org/volumedriver v0.162.0 // indirect
