...
require (
	code.cloudfoundry.org/cfhttp/v2 v2.68.0 // indirect
	code.cloudfoundry.org/credhub-cli v0.0.0-20260206183640-c92cc3cf00d6 // indirect
	code.cloudfoundry.org/dockerdriver v0.74.0 // indirect
	code.cloudfoundry.org/tlsconfig v0.44.0 // indirect
	code.cloudfoundry.org/volumedriver v0.158.0 // indirect
